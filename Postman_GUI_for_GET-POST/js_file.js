...
submit.addEventListener('click', () => {
    ...
    let requestType = document.querySelector("input[name='requestType']:checked").value;
        //above code's used to get value of input tag with name='requestType' & having radio button checked
    ...
    if (requestType=='GET'){
        ...
        .then((text) =>{
            ...
            Prism.highlightAll();
                   // the above is Prism js's method so tht text in our Response box is highlightes
        });
    }
